...
class MissingTransformationCommentCheckTest {

    private MissingTransformationCommentCheck check;
    ...
    @BeforeEach
    void setUp() {
        check = new MissingTransformationCommentCheck();
    ...
    void testScanFileWithNullDocument() {
        // Use empty document instead of null - null handling is done at sensor level
