...
class DatabaseConnectionWithoutEncryptionCheckTest {

    private DatabaseConnectionWithoutEncryptionCheck check;
    ...
    @BeforeEach
    void setUp() {
        check = new DatabaseConnectionWithoutEncryptionCheck();
