...
class MissingErrorHandlerCheckTest {

    private MissingErrorHandlerCheck check;
    ...
    @BeforeEach
    void setUp() {
        check = new MissingErrorHandlerCheck();
        ...
        when(location.at(any())).thenReturn(location); // Handle TextRange parameter
